...
{
	partial class FormMainIWCameraListBeautifier
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			// FormMainIWCameraListBeautifier
			// 
			...
			this.Location = new System.Drawing.Point(500, 430);
			this.Name = "FormMainIWCameraListBeautifier";
			this.StartPosition = System.Windows.Forms.FormStartPosition.Manual;
			this.Text = "Integration Wrapper - Camera List Beautifier";
